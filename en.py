...
VIDEOS = [
    "https://app.ofppt-langues.ma/platform/learning-path/mission/TALKING_ABOUT_CRIMINAL_ACTIVITIES/lesson/EN_GB_C1_VOCABULARY_COMPARING_CRIME_PREVENTION_MEASURES/activity/EN_GB_C1_VOCABULARY_COMPARING_CRIME_PREVENTION_MEASURES_VIDEO_ANIMATION_GOOD_TIPS_FOR_CROOKS",
]
